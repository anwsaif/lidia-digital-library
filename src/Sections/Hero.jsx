...
function Hero() {
  return (
    <section>
      <div className="container mx-auto px-5 py-2 lg:px-24 lg:py-14">
        <div className="relative flex flex-col-reverse items-center md:flex-row ">
          <div className="flex flex-col gap-4 md:w-1/2 md:gap-8">
            ...
            <p className='line-clamp-2 text-sm text-desc'>Embark on a literary journey like never before with our revolutionary library application! Introducing a seamless experience that transcends traditional boundaries, where  you can effortlessly search your favorite books.✨</p>
