  ...
  return (
    <section className='md:h-[85vh]'>
      <div className="container mx-auto flex h-full px-4 py-16 md:px-4 md:pt-52 lg:px-5 lg:py-7 xl:px-10 ">
        ...
        <div className='absolute right-0 top-0 -z-30 h-[26rem] w-[75vw] bg-[url("./assets/Cover.svg")] bg-cover bg-no-repeat min-[516px]:w-[64vw] sm:w-[55vw] md:h-[107vh] lg:max-w-[37.875rem] xl:h-[130vh] xl:max-w-none '></div>
      </div>
    </section>
  )
}
