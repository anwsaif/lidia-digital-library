      ...
      <div className="container mx-auto flex h-full px-4 py-2 md:px-4 lg:px-5 lg:py-7 xl:px-10 ">
        <div className="relative flex w-full flex-col-reverse items-center md:flex-row md:gap-x-7 ">
          <div className="flex flex-col gap-4 md:w-1/2 md:gap-8">
            ...
            <a href="#" className='md:px-13 h-12 w-40 rounded-10 bg-primary px-6 py-3 text-center text-sm font-bold leading-6 text-white transition duration-300 ease-in-out hover:opacity-40 md:h-[3.75rem] md:w-[12.5rem] md:py-[1.125rem] lg:text-base'>Start now →</a>
          </div>
