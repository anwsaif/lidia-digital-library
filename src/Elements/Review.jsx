...
function Review({logo, name, review, occupation, index}) {
  return (
    <div key={index} data-aos="fade-right" data-aos-duration={(index === 0) ? '400' : ((index === 1) ? '800' : '1200')} className='review h-fit w-fit max-w-[366px] bg-white px-12 py-10 text-center shadow-[inset_0px_0px_1px_1px_#DEDEDE] md:w-[45%] lg:px-[3.625rem]'>
